...
namespace ResourceTools.Editor
{
    public partial class AssetRuntimeInfoWindow
    {
        ...
        private void InitAssetInfoView()
        {
            ...
            bundleInfoDict = typeof(AssetBundlesManager).GetField("bundleInfoDict", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<string, BundleRuntimeInfo>;
            assetInfoDict = typeof(AssetBundlesManager).GetField("assetInfoDict", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<string, AssetRuntimeInfo>;
