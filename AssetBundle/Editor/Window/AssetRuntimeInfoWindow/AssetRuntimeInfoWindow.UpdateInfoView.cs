...
namespace ResourceTools.Editor
{
    public partial class AssetRuntimeInfoWindow
    {
        ...
        private void InitUpdateInfoView()
        {
            ...
            groupUpdaterDict = typeof(ResourceToolsUpdater).GetField("groupUpdaterDict", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<string, Updater>;
        }
