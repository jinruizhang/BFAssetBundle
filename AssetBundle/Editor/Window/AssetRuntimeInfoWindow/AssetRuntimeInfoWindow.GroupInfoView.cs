...
namespace ResourceTools.Editor
{
    public partial class AssetRuntimeInfoWindow
    {
        ...
        private void InitGroupInfoView()
        {
            ...
            groupInfoDict = typeof(AssetBundlesManager).GetField("groupInfoDict", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<string, GroupInfo>;
        }
