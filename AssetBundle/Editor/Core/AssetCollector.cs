...
namespace ResourceTools.Editor
{
    ...
    /// TODO 遍历文件合并一个Bundle写到具体的方法中了拆分出来
    /// </summary>
    public static class AssetCollector
    {
        ...
        /// 存放在本地的Bundle资源
        /// </summary>
        private static List<string> localBundles = new List<string>();
        ...
        static AssetCollector()
        {
            ...
            assetBundleGroupDict.Add("common.bundle", AssetBundlesConfig.DefaultGroup);
        }
        ...
        /// 添加AssetBundle所在的资源组
        /// </summary>
        public static void AddAssetBundleGroup(string assetBundleName,string groupName = AssetBundlesConfig.DefaultGroup)
        {
        ...
        public static void AddLocalAssetBundleGroup(string assetBundleName)
        {
            localBundles.Add(assetBundleName);
        }

        public static bool IsLocalAssetBundle(string assetBundleName)
        {
            return localBundles.Contains(assetBundleName);
        }
        ...
        private static AssetBundleBuild[] TopDirectoryNAssetToOneBundle(PackageRule rule)
        {
            ...
            if (Directory.Exists(rule.Directory))
            {
                ...
                /// 将一级目录以外的资源打包成一个Bundle
                FileInfo[] current_files = dirInfo.GetFiles("*", SearchOption.TopDirectoryOnly);
        ...
        /// 对指定文件夹下所有一级子目录各自使用NAssetToOneBundle打包为一个bundle
        /// </summary>
        private static AssetBundleBuild[] TopDirectoryNAssetToOneBundle1(PackageRule rule)
        {
            List<string> assetPaths = new List<string>();
            List<AssetBundleBuild> abBulidList = new List<AssetBundleBuild>();
